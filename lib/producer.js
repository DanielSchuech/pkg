...
import { transformPackageJson } from './utils.js';
      ...
      if (count === 2) {
        ...
        if (stripes.length) {
          ...
          if (stripe.file) {
            ...
            return cb(undefined, pipeToNewMeter(fs.createReadStream(stripe.file).pipe(transformPackageJson(stripe.file, config))));
          } else {
